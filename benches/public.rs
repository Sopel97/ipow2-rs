...
mod div {
    ...
    make_bench_for_all_ints!(
        ...
        unb_pow2_div_round       : for_unb_pow2       => |a, b| ipow2::div_round(a, b),
        unb_pow2_div_round_const : for_const          => |a|    ipow2::div_round(a, CONST_UNB_POW2),
        unb_pow2_div_round_reuse : for_unb_pow2_reuse => |a, b| ipow2::div_round(a, b),
        pow2_div_round           : for_pow2           => |a, b| ipow2::div_round(a, b),
        pow2_div_round_const     : for_const          => |a|    ipow2::div_round(a, CONST_POW2),
        pow2_div_round_reuse     : for_pow2_reuse     => |a, b| ipow2::div_round(a, b),
...
mod round {
    ...
    make_bench_for_all_ints!(
        ...
        unb_pow2_round_to_multiple       : for_unb_pow2       => |a, b| ipow2::round_to_multiple(a, b),
        unb_pow2_round_to_multiple_const : for_const          => |a|    ipow2::round_to_multiple(a, CONST_UNB_POW2),
        unb_pow2_round_to_multiple_reuse : for_unb_pow2_reuse => |a, b| ipow2::round_to_multiple(a, b),
        pow2_round_to_multiple           : for_pow2           => |a, b| ipow2::round_to_multiple(a, b),
        pow2_round_to_multiple_const     : for_const          => |a|    ipow2::round_to_multiple(a, CONST_POW2),
        pow2_round_to_multiple_reuse     : for_pow2_reuse     => |a, b| ipow2::round_to_multiple(a, b),
